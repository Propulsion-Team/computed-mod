...
public final class EqualNode extends ComparisonNode {
    public static final ResourceLocation TYPE_ID = BuiltinNodeIds.of("cmp_eq");
    ...
    public EqualNode(int x, int y) { super(TYPE_ID, "=", "A = B", x, y, (a, b) -> a == b); }

    public static void register() {
        NodeRegistry.register(TYPE_ID, EqualNode::new);
